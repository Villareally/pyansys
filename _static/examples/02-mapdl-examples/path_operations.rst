.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_examples_02-mapdl-examples_path_operations.py>`     to download the full example code
...
.. image:: /examples/02-mapdl-examples/images/sphx_glr_path_operations_001.png
    :alt: path operations
...
.. image:: /examples/02-mapdl-examples/images/sphx_glr_path_operations_002.png
    :alt: path operations
    :class: sphx-glr-single-img
...
.. image:: /examples/02-mapdl-examples/images/sphx_glr_path_operations_003.png
    :alt: path operations
    :class: sphx-glr-single-img
